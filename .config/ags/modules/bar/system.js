...
const BarClock = () => Widget.Box({
    ...
    children: [
        ...
        // Widget.Label({
        //     className: 'bar-clock',
        //     label: GLib.DateTime.new_now_local().add_hours(8).format("%H:%M"),
        //     setup: (self) => self.poll(5000, label => {
        //         label.label = GLib.DateTime.new_now_local().add_hours(8).format("%H:%M");
        //     }),
        // }),
        Widget.Label({
            className: 'bar-clock',
            label: new Intl.DateTimeFormat('en-US', {
                ...
                hour: '2-digit', // Ensure leading zeros if needed
                minute: '2-digit'
            }).format(new Date()),
            setup: (self) => self.poll(5000, label => {
                label.label = new Intl.DateTimeFormat('en-US', {
                    timeZone: 'Asia/Seoul',
                    hour12: false,
                    hour: '2-digit',
                    minute: '2-digit'
